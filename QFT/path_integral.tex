...
$\E{\varphi(x_1)\varphi(x_2)...} = \E{\Omega|T \left\{\varphi(x_1)\varphi(x_2)\dots\right\}|\Omega}$,
where $T$ is the time ordering operator.
These are given by functional derivatives of $Z[J]$,
%
\begin{equation}
    \label{correlator from generating functional}
    \E{\varphi(x_1)\varphi(x_2)...}
    = 
...
%
\begin{equation}
    \E{{\prod}_{i=1}^{n} \varphi(x_i)  }_0
    = \sum_{\{(a, b)\}}  \prod_{i=1}^{\floor{n/2}}  \E{\varphi(x_{a(i)}) \varphi(x_{b(i)})}_0.
\end{equation}
%
...
\begin{equation}
    ...
    Z[J] 
    = Z_0[0] \E{\exp{iS_I + i\int \dd^4 x \, J(x) \varphi(x)}}_0.
\end{equation}
%
...
%
\begin{equation}
    \sum_{n, m} \frac{1}{n! m!} \E{(iS_I)^n \left(i\int \dd^4 x \, J(x) \varphi(x)\right)^m}_0.
\end{equation}
%
...
\begin{align}
    ...
    \Em = 
    \includegraphics[width=0.60\textwidth, valign=c]{figurer/diagram_sum.pdf}
    \dots.
\end{align}
%
